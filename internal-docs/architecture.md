# Architecture — Custom Template for LearnDash

## Overview

Custom Template for LearnDash is a WordPress plugin that follows standard WordPress plugin architecture patterns.

## Entry Point

The plugin entry point is `custom-template-learndash.php`, which:
...
1. WordPress loads the plugin via `custom-template-learndash.php`
