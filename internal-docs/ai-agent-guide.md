# AI Agent Guide — Custom Template for LearnDash

## Quick Start for AI Agents

1. **Entry point:** Start at `custom-template-learndash.php` to understand plugin initialization
...
4. **Text domain:** Use `custom-template-learndash` for all translatable strings
...
1. Wrap strings in `__( 'text', 'custom-template-learndash' )` or `esc_html__( 'text', 'custom-template-learndash' )`
...
- [ ] Text domain `custom-template-learndash` used for all user-facing strings
